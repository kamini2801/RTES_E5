...
unsigned int reqIterations = 500;
...
long int max (long int arr[], int len) {
...
{
    struct timeval current_time_val;
    struct timespec delay_time = {0,333333}; // delay for 3000 Hz
